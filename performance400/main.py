...
if EXTRACT_MIRE:
    left_mire = cv.VideoCapture("videos/mires/left_mire_course2.MOV")
    right_mire = cv.VideoCapture("videos/mires/right_mire_course2.MOV")
    intrinsic_pre_autocalibration.extract_targets(left_mire, 100, False)
    intrinsic_pre_autocalibration.extract_targets(right_mire, 100, True)
